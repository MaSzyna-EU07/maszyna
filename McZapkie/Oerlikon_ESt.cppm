...
export module eu07.mczapkie.oerlikon_est;
import eu07.mczapkie.hamulce;
import eu07.mczapkie.friction;

export {

inline int const dMAX = 11; // dysze
inline int const dON = 0; // osobowy napelnianie (+ZP)
inline int const dOO = 1; // osobowy oproznianie
inline int const dTN = 2; // towarowy napelnianie (+ZP)
inline int const dTO = 3; // towarowy oproznianie
inline int const dP = 4; // zbiornik pomocniczy
inline int const dSd = 5; // zbiornik sterujacy
inline int const dSm = 6; // zbiornik sterujacy
inline int const dPd = 7; // duzy przelot zamykajcego
inline int const dPm = 8; // maly przelot zamykajacego
inline int const dPO = 9; // zasilanie pomocniczego O
inline int const dPT = 10; // zasilanie pomocniczego T

// przekladniki
inline int const p_none = 0;
inline int const p_rapid = 1;
inline int const p_pp = 2;
inline int const p_al2 = 3;
inline int const p_ppz = 4;
inline int const P_ed = 5;
