...
export module eu07.application.uilayer;
import eu07.glm;
...
// ui::popup and ui_panel refer to each other, so they have to share a module:
// a forward declaration cannot cross a module boundary. popup only needs the
// name, while ui_panel holds popups by value in a list and needs the definition.
class ui_panel;
