...
{ // klasa submodelu - pojedyncza siatka, punkt świetlny albo grupa punktów
    ...
    // the :fwd declaration is enough for a friend; importing :dynobj here would
    // close a partition cycle model3d -> dynobj -> traction -> scenenode -> model3d
