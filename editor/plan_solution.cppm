...
export module eu07.editor.plan_solution;
...
struct SolvedElement {
    ...
    Kind kind{Kind::Line};
    geometry::Pose start{};  ///< pose the element is laid from
    geometry::Pose end{};    ///< pose it ends on = the next element's start
...
struct SolvedTurnoutSegment {
    ...
    plan::TurnoutPart part{plan::TurnoutPart::Curve};
