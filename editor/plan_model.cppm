...
export module eu07.editor.plan_model;
...
/// plan::TurnoutPiece; kept here so the document does not depend on the
/// geometry header.
...
/// The blade's own dimensions, which place its cut tip. Mirrors plan::Blade.
struct BladeSpec {
